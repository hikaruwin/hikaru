...
class WidgetsDemo:
    ...
    def __init__(self):
        ...
        btAddClass = Button(frame1, text=u'获取验证码', command=self.btRequest)
        btAddClass.grid(row=2, column=2)
        global m
        m = Label(frame1, text='')
        m.grid(row=3, column=2, columnspan=2)
    ...
    def btRequest(self):
        ...
        # rtype = var.get()
        url = 'http://admin.pnlyy.com/support/official-code-data'
        params = {'abstract_content': reqphone, '_': '1531883858423'}
