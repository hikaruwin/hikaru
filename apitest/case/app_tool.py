...
class WidgetsDemo:
    ...
    def btReg(self):
        ...
        # rtype = var.get()
        r = req('https://xiaohei-api.dev.pnlyy.com/v4/login/phone-code', '', '', '2.2.0', '0', '192.168.56.1',
                'sdsdasd', '0', cellphone=reqPhone, type='2', areaCode='+86')
        verCode1 = (r[u'data'])[u'code']
        r = req('https://xiaohei-api.dev.pnlyy.com/v4/login/register', '', '', '2.2.0', '0', '192.168.56.1', 'sdsdasd',
                '0', username=reqPhone, nickName=reqUser, pwd='123456a', type='0', areaCode='+86', code=str(verCode1))
        print r
        mess = r[u'message']
