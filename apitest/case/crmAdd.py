...
def crm(userid, teacherid, starttime):
    para = {'time_type': '3', 'instrument_id': '1', 'weeks': '1', 'marks': '', 'is_red': '0', 'ttype': '0', 'conflict_id':'0'}
    # time_type = '3'
    # instrument_id = '1'
    # weeks = '1'
    # marks = ''
    ...
    datapara = dict(para.items()+student_id.items()+teacher_id.items()+time_start.items())
    print datapara
    # paramsort.sort()
